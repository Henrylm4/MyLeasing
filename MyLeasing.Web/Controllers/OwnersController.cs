...
namespace MyLeasing.Web.Controllers
{
    ...
    public class OwnersController : Controller //Este controlador tambien trabajo con la tabla de contratos, propiedades etc
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var owner = await _dataContext.Owners.Include(o => o.User).Include(o => o.Properties).ThenInclude(p => p.PropertyImages).Include(o => o.Contracts).ThenInclude(c => c.Lessee).ThenInclude(l => l.User)
        ...
        {//para llenar la view de crear propiedad 
            if (id == null)
            {
                return NotFound();
            }
        ...
        {//es el post para que los datos ingresados creen la nueva propiedad 
            if (ModelState.IsValid)
            {
        ...
        {//para llenar la view de crear propiedad 
            ...
            var property = await _dataContext.Properties.Include(p => p.Owner).Include(p => p.PropertyType).FirstOrDefaultAsync(p => p.Id == id);
            if (property == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> Edit(int? id)//el signo de pregunta es porque puede llegar a entrar un nulo
        {
            if (id == null) //siempre validar esto por si no entra un id 
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> DetailsProperty(int? id)
        {
            ...
            var property = await _dataContext.Properties //Esto es como un select con millon inner joins
                .Include(o => o.Owner)
