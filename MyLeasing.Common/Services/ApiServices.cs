    ...
    public class ApiService : IApiService
    {
            ...
            TokenRequest request)// el usuario y contrase;a
        {
            try
            {
                ...
                {
                    return new Response<TokenResponse> //se retorna una respesta de que no hubo login
                    {
                        IsSuccess = false,
                        Message = result,
                    };
        ...
        public async Task<bool> CheckConnection(string url)//metodo para saber si el telefono tiene internet
        {
